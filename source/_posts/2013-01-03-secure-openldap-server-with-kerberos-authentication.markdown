...
## slapd.conf
Create a ```/etc/openldap/slapd.conf``` to configure your server. You can grab a copy of my basic configuration file <a href="http://archive.grantcohoe.com/projects/ldap/slapd_basic.conf">here</a>.
``` text
